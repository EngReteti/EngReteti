...
🔭 I'm currently working on **MongoDB**, **Prisma**, **Flutter in Dart**, **PWA**, **GraphQL**, **Django**, **NextJs**, **VueJS**, **Angular**, **NestJS** and **Typescript**.
...
💬 Ask me about **SQL**, **NoSQL**, **ExpressJS**, **NodeJS**, **React**, **Vite**, **React Native Expo**, **Spring Boot**, **Apache Maven**, **Hibernate**, **Rest API**, **UI & UX**, **Cloudinary API**, **Deployment**, **Payment Gateways**
...
* **DevOps:** I plan to master **Docker**, **Kubernetes**, **Terraform for IaC**, **containerization**, and **CI/CD Pipelines** to bridge the gap between development and automated infrastructure.
