...
🔭 I'm currently working on **MongoDB**, **OracleDB**, **Redis**, **Prisma**, **Flutter in Dart**, **GraphQL**, **Django**, **NextJs**, **VueJS**, **Angular**, **NestJS** and **Typescript**.
...
💬 Ask me about **SQL**, **ExpressJS**, **NodeJS**, **React**, **Vite**, **React Native Expo**, **PWA**, **Spring Boot**, **Apache Maven**, **Hibernate**, **Rest API**, **Cloudinary**, **Payment Gateways**
